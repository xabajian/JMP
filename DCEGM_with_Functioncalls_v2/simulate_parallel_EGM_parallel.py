...
from solve_EGM_par import solve_EGM_par
from numba import njit, prange
from step_markov_chain import step_markov_chain

@njit(parallel=True)
def simulate_parallel_EGM_parallel(labor_paths,seed_assets,prod_states,
    ...
    model_solutions = solve_EGM_par(m_matrix,model_in, m_egm_0,c_egm_0,v_egm_0,ev_egm_0)
