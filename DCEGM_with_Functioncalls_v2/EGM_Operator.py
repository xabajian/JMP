...
@njit
def EGM_Operator(m_egm_in,c_egm_in,v_egm_in,ev_egm_in, model_in,m_matrix):
    ...
    for s,labor in enumerate(s_grid):
        ...
        for j in range(number_locations):
                ...
                for k in range(number_locations):
                    ...
                    for i in range(len(asset_grid)):
                        ...
                        for m in range(number_locations):
                        ...
                        for h in range(number_locations):
